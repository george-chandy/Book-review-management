...
class Book(Base):
    ...
    category = relationship("Category", back_populates="books", lazy="joined")
    genre = relationship("Genre", back_populates="books", lazy="joined")
    language = relationship("Language", back_populates="books", lazy="joined")
